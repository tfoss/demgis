...
def main():
    parser = argparse.ArgumentParser(description="Generate North + Central American country STLs")
    parser.add_argument("--dem", required=True, help="North Central America DEM (e.g. nca_1km_smooth.tif)")
