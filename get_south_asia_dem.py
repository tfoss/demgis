#!/usr/bin/env python3
"""
Download Copernicus DEM tiles for South Asia region.

Coverage:
- Pakistan: ~60-78°E, 23-37°N
- India: ~68-97°E, 8-35°N
- Nepal: ~80-88°E, 26-30°N
- Bhutan: ~89-92°E, 27-28°N
- Bangladesh: ~88-93°E, 21-27°N
- Sri Lanka: ~79-82°E, 6-10°N
- Maldives: ~72-74°E, -1-7°N

Total coverage: ~60-97°E, -1-37°N
"""
...
# South Asia bounding box: ~60-97°E, -1-37°N
LON_RANGE = range(60, 98)  # 60-97°E
LAT_RANGE = range(-1, 38)  # -1-37°N
...
def main():
    output_dir = Path("south_asia_tiles")
    output_dir.mkdir(exist_ok=True)

    print(f"Downloading South Asia DEM tiles to: {output_dir}")
