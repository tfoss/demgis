...
# Europe bounds (integer degrees)
# Covers all of Europe including Iceland, European Russia, Turkey
LAT_MIN, LAT_MAX = 35, 72
LON_MIN, LON_MAX = -25, 60

TILELIST_PATH = "tileList.txt"
OUT_PATH = "europe_tile_urls_s3.txt"
...
def main():
    ...
    print(f"Europe tiles written to {OUT_PATH}: {count_keep}")
