...
# Africa bounds (integer degrees)
# Includes entire African continent + Madagascar
# Excludes small island nations
LAT_MIN, LAT_MAX = -35, 38
LON_MIN, LON_MAX = -18, 52

TILELIST_PATH = "tileList.txt"
OUT_PATH = "africa_tile_urls_s3.txt"
...
def main():
    ...
    print(f"Africa tiles written to {OUT_PATH}: {count_keep}")
