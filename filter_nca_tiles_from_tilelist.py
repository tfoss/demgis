...
# North + Central America bounds (integer degrees)
# Includes Canada, USA, Mexico, Central America down to Panama
# Excludes Caribbean, Greenland, Alaska islands beyond -170
LAT_MIN, LAT_MAX = 7, 72
LON_MIN, LON_MAX = -170, -52

TILELIST_PATH = "tileList.txt"
OUT_PATH = "nca_tile_urls_s3.txt"
...
def main():
    ...
    print(f"North + Central America tiles written to {OUT_PATH}: {count_keep}")
